...
function generator(adj, noun) {
  console.log("The adjective is "+adj+ " and the noun is " + noun);
...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/pizza-small.png";
...
var resizePizzas = function(size) {
  ...
  function determineDx (elem, size, window, oldsize) {
    var windowWidth = window;
    var oldWidth = oldsize;
